defmodule AuctionWeb.Telemetry do
  ...
  def metrics do
    [
      ...
      summary("auction_web.repo.query.total_time", unit: {:native, :millisecond}),
      summary("auction_web.repo.query.decode_time", unit: {:native, :millisecond}),
      summary("auction_web.repo.query.query_time", unit: {:native, :millisecond}),
      summary("auction_web.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("auction_web.repo.query.idle_time", unit: {:native, :millisecond}),
